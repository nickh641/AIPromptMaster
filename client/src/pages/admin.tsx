    ...
    <div className="h-full p-6">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-6">Prompt Manager</h2>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {promptsArray.map((prompt) => (
                          <tr key={prompt.id}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{prompt.temperature}</td>
